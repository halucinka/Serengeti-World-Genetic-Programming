...
public class GetFirstNearestGrassDistance extends Node {

	public GetFirstNearestGrassDistance(Animal animal) {
		super(animal);
	}

	public GetFirstNearestGrassDistance(Animal animal, Serengeti sgt) {
		super(animal);
