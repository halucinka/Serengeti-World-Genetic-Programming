...
public class GetSecondNearestGrassDistance extends Node {

	public GetSecondNearestGrassDistance(Animal animal) {
		super(animal);
	}

	public GetSecondNearestGrassDistance(Animal animal, Serengeti sgt) {
		super(animal);
