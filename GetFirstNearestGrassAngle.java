...
public class GetFirstNearestGrassAngle extends Node {

	public GetFirstNearestGrassAngle(Animal animal) {
		super(animal);
	}

	public GetFirstNearestGrassAngle(Animal animal, Serengeti sgt) {
		super(animal);
