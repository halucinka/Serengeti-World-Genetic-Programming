...
public class GetSecondNearestGrassAngle extends Node {

	public GetSecondNearestGrassAngle(Animal animal) {
		super(animal);
	}

	public GetSecondNearestGrassAngle(Animal animal, Serengeti sgt) {
		super(animal);
