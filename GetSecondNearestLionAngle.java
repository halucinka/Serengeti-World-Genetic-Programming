...
public class GetSecondNearestLionAngle extends Node {

	public GetSecondNearestLionAngle(Animal animal) {
		super(animal);
	}

	public GetSecondNearestLionAngle(Animal animal, Serengeti sgt) {
		super(animal);
