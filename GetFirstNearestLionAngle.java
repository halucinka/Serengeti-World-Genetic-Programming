...
public class GetFirstNearestLionAngle extends Node {

	public GetFirstNearestLionAngle(Animal animal) {
		super(animal);
	}

	public GetFirstNearestLionAngle(Animal animal, Serengeti sgt) {
		super(animal);
		data = "nearest lion";
		ch = 1;
		this.sgt = sgt;
