...
public class GetThirdNearestGazelleDistance extends Node {

	public GetThirdNearestGazelleDistance(Animal animal) {
		super(animal);
	}

	public GetThirdNearestGazelleDistance(Animal animal, Serengeti sgt) {
		super(animal);
