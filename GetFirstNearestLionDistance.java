...
public class GetFirstNearestLionDistance extends Node {

	public GetFirstNearestLionDistance(Animal animal) {
		super(animal);
	}

	public GetFirstNearestLionDistance(Animal animal, Serengeti sgt) {
		super(animal);
		data =  "nearest lion";
		ch = 1;
		this.sgt = sgt;
