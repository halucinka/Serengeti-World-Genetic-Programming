...
import java.util.Iterator;
	...
	public class GetSecondNearestGazelleAngle extends Node {

		public GetSecondNearestGazelleAngle(Animal animal) {
			super(animal);
		...
		public GetSecondNearestGazelleAngle(Animal animal, Serengeti sgt) {
			super(animal);
